...
export const TRYITON_PRODUCTS: DemoProduct[] = [
  ...
  { id: 'ti-06', slug: 'dhoti-jumpsuit-fusion', name: 'Mustard Peplum Lehenga Set', category: 'Ethnic Fusion', price: 2699,
    description: 'A flowing peplum lehenga skirt in mustard with a fitted embroidered blouse — festive, without the full nine-yards commitment.',
    detail: 'Fitted peplum blouse, flared lehenga skirt, dupatta included.', fabric: 'Silk blend', fit: 'Relaxed lehenga silhouette',
  ...
  { id: 'ti-08', slug: 'embellished-flat-sandals', name: 'Embellished Gladiator Sandals', category: 'Footwear', price: 999, originalPrice: 1299,
    description: 'Gladiator-strap sandals with crystal and gold-tone embellishments — festive comfort for when heels aren\'t the move.',
    detail: 'Crystal-embellished straps, cushioned sole.', fabric: 'Faux leather', fit: 'True to size',
    sizes: ['5', '6', '7', '8'], colors: ['Ivory & Gold'], tags: ['sale'], image: IMG('embellished-flat-sandals') },
]
