...
export function lowCreditsEmail({
  ...
  return {
    subject: `Low AI credits — ${creditsRemaining} remaining for ${brandName}`,
    html: `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Low AI credits — ${brandName}</title>
</head>
          ...
          <tr>
            <td style="background:#ffffff;border-radius:6px;padding:44px 40px;">
              ...
              <h1 style="margin:0 0 16px 0;font-size:26px;font-weight:400;line-height:1.3;color:${INK};">
                ${brandName} has ${creditsRemaining} AI credits left
              </h1>
              <p style="margin:0 0 28px 0;font-size:15px;line-height:1.7;color:${INK}bb;font-family:Arial,sans-serif;">
                Your buyers are using the AI try-on feature — credits are going fast. When they run out, try-on will be temporarily unavailable in your store. Upgrade or top up from your billing page to keep it running.
              </p>
          ...
          <tr>
            <td style="padding:32px 24px 0;text-align:center;">
              <p style="margin:0 0 8px 0;font-size:12px;color:${INK}77;font-family:Arial,sans-serif;">
                Usage notifications for <strong style="color:${INK}88;">${brandName}</strong> on Instastarz.
              </p>
