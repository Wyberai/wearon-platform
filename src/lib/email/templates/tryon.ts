...
<body style="margin:0;padding:0;background:#09090B;font-family:'Segoe UI',Arial,sans-serif;color:#fff;">
  <div style="max-width:560px;margin:0 auto;padding:40px 24px;">
    <div style="margin-bottom:32px;">
      <span style="background:#F72585;color:#fff;padding:6px 14px;border-radius:20px;font-size:12px;font-weight:700;letter-spacing:1px;text-transform:uppercase;">Instastarz</span>
    </div>
    ...
    <p style="font-size:12px;color:#52525b;margin:0;text-align:center;">
      You're receiving this because you have a store on Instastarz · <a href="#" style="color:#F72585;text-decoration:none;">Unsubscribe</a>
    </p>
  </div>
</body>
</html>`,
