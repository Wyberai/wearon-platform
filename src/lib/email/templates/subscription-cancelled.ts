...
export function subscriptionCancelledEmail({
  ...
  return {
    subject: 'Your Instastarz subscription has been cancelled',
    html: `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
          ...
          <tr>
            <td style="background:#ffffff;border-radius:6px;padding:44px 40px;">
              ...
              <h1 style="margin:0 0 16px 0;font-size:26px;font-weight:400;line-height:1.3;color:${INK};">
                ${brandName}'s subscription has been cancelled
              </h1>
              <p style="margin:0 0 28px 0;font-size:15px;line-height:1.7;color:${INK}bb;font-family:Arial,sans-serif;">
                Your plan has been downgraded to the <strong style="color:${INK};">Free tier</strong>. Your store is still live, but paid features — AI try-on, the mobile app, and higher product limits — are no longer available.
              </p>
              <p style="margin:0 0 28px 0;font-size:15px;line-height:1.7;color:${INK}bb;font-family:Arial,sans-serif;">
                You can resubscribe at any time from your billing page.
              </p>
